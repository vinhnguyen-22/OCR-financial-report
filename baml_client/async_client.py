...
class BamlAsyncClient:
    ...
    async def ExtractInvoices(
        self,
        images: List[baml_py.Image],
      ...
      return cast(types.Invoices, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ExtractInvoices(
        ...
        images: List[baml_py.Image],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Invoices, types.Invoices]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.Invoices, types.Invoices](
        raw,
        lambda x: cast(partial_types.Invoices, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.Invoices, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
